    ...
    <header>
        <div class="container">
            <nav>
                ...
                <ul>
                    <li><a id="2" href="http://localhost:7486/MiniProject/TeacherServlet">Teachers</a></li>
                    <li><a id="3" href="http://localhost:7486/MiniProject/StudentServlet">Students</a></li>
                </ul>
                <div class="profile">
                    <div>
                        <p id="userName">${admin.firstname} ${admin.lastname}</p>
                    </div>
                    <ul>
